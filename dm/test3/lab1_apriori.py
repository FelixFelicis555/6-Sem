...
def main():
    dataset = load_csv(
        '/Users/adityakaria/code/6-Sem/dm/test3/retail_dataset.csv')
    ...
    idx = int(input(
        "-> Enter the index of frequent itemset for generating association rules:"))
    print("Given below are all Association rule:")
