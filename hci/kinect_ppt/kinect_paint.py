...
# Use the Kinect to control your Paint application
...
def zeros(length): return [0 for _ in range(length)]
...
def get_min_pos_kinect():
    ...
    # This is the raw index of the minimum value above
    minPos = np.argmin(depth)
